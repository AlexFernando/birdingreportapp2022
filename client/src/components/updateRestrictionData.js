...
const UpdateRestrictionData = () => {

    const [file, setFile] = useState('');
    const [filename, setFilename] = useState('Choose Restriction Data');
    ...
    const onChange = e => {
        ...
        setFilename('restrictionData.xlsx');
      };
      ...
      const onSubmit = async e => {
        ...
        try {
          const res = await axios.post('/updaterestrictiondata', formData, {
            headers: {
          ...
          setTimeout(() =>  setMessage('Your file containning Restriction data has been updated.'), 6000);
...
export default UpdateRestrictionData;